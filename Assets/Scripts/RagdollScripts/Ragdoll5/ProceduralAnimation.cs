...
public class ProceduralAnimation : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        scaler.localScale = new Vector3(
            scaler.localScale.x,
            stepHeight * 2f * velocity.magnitude,
        ...
        {
            leftFootTargetRig.rotation = Quaternion.LookRotation(
                sign * velocity.normalized,
                posNormLeft[1]
            );
        }
        ...
        {
            rightFootTargetRig.rotation = Quaternion.LookRotation(
                sign * velocity.normalized,
                posNormRight[1]
            );
        }
        ...
        float feetDistance = Mathf.Clamp01(
