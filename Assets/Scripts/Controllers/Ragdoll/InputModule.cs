...
namespace ActiveRagdoll
{
    ...
    public class InputModule : Module
    {
        ...
        Rigidbody _rightFoot,
            _leftFoot;

        void Start()
        {
            _rightFoot = _activeRagdoll
                .GetPhysicalBone(HumanBodyBones.RightFoot)
                .GetComponent<Rigidbody>();
            _leftFoot = _activeRagdoll
                .GetPhysicalBone(HumanBodyBones.LeftFoot)
                .GetComponent<Rigidbody>();
        }
        ...
        private void UpdateOnFloor()
        {
            ...
            _isOnFloor =
                CheckRigidbodyOnFloor(_rightFoot, out Vector3 foo)
